...
const InstructorDashboard = () => {
  ...
  useEffect(() => {
    const loadCourses = async () => {
      try {
        ...
        setError(error.message || "Unable to load instructor dashboard.");
      } finally {
        setLoading(false);
      }
    };
  ...
  */
  ...
  // If showing profile, render only the profile component
  if (showProfile) {
    return (
  ...
  return (
    <div className="instructor-dashboard-content">
      ...
      <header className="instructor-topbar">
        <div className="instructor-welcome">
          <p>Instructor Dashboard</p>
          <h1>Welcome back, {getInstructorName()}!</h1>
        </div>
      ...
      <section className="instructor-overview">
        ...
        <div className="instructor-stats">
          ...
          <div className="instructor-stat-card">
            ...
            <p className="stat-description">Total courses created</p>
          </div>
          ...
          <div className="instructor-stat-card">
            ...
            <strong>
              {courses.filter(course => course.published === true).length}
            </strong>
            <p className="stat-description">Courses available to students</p>
          </div>
          ...
          <div className="instructor-stat-card">
            ...
            <p className="stat-description">Students enrolled in your courses</p>
          </div>
          ...
          <div className="instructor-stat-card">
            ...
            <p className="stat-description">Lessons across your courses</p>
          </div>
        </div>
      </section>
      ...
      <div className="instructor-dashboard-grid">
        ...
        <section className="recent-courses-section">
          <div className="section-heading">
            ...
            <NavLink to="/instructor/courses" className="view-all-link">
              View all
            </NavLink>
          </div>
          ...
          {loading ? (
            <div className="dashboard-message">Loading courses...</div>
          ) : error ? (
            ...
            <div className="dashboard-empty">
              ...
              <NavLink to="/instructor/courses" className="create-course-link">
                Create Course
              </NavLink>
            </div>
          ) : (
            <div className="recent-course-list">
              {courses.slice(0, 3).map(course => (
                <div className="recent-course-item" key={course._id}>
                  {/* COURSE IMAGE */}
